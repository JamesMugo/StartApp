			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
				<div class="panel panel-info" id="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Alieu Jallow</h3>
					</div>
								...
								<table class="table table-user-information">
									<tbody>
										...
										<tr>
											...
											<tr>
												<td>Home Address</td>
												<td>londoncorner,serekunda</td>
											</tr>
											<tr>
												<td>Email</td>
												<td><a href="mailto:info@support.com">alieujallow93@gmail.com</a></td>
											</tr>
											<td>Phone Number</td>
					...
					<div class="panel-footer">
						 <button type="submit" class="btn btn-primary btn-lg col-md-12" id="submitBtn1">Add to favorites</button>
					</div>
