...
<head>
  ...
  <!--css links begins-->
  <?php require_once('MeetYourInvestor/layout/cssLinks.php');?>
  <!--csslinks ends-->
...
<body>
  ...
  ?>	
	<!--header begins-->
  <?php
   require_once('MeetYourInvestor/layout/mainHeader.php');
  ?>
  <!--header ends-->
...
<!--REGISTER ENDS HERE-->
    ...
    <!--footer begins-->
      <?php require_once('MeetYourInvestor/layout/mainFooter.php');?>
    <!--footer ends-->
